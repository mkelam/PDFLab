...
export async function initiateOAuth(providerId: string): Promise<void> {
  ...
  if (providerId === 'google') {
    ...
    console.warn(`OAuth not supported for provider: ${providerId}`)
    throw new Error('Only Google authentication is supported. Please use Google or email/password login.')
  }
}
