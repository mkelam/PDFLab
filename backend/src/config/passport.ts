...
if (process.env.GOOGLE_CLIENT_ID) {
    ...
    new GoogleStrategy(
      {
        ...
        callbackURL:
          process.env.GOOGLE_CALLBACK_URL || 'http://localhost:3006/api/auth/google/callback'
      },
  ...
  console.log('[Passport] Google OAuth disabled - GOOGLE_CLIENT_ID not configured')
}
  ...
  const linkedInStrategy = new OAuth2Strategy(
    {
      ...
      callbackURL:
        process.env.LINKEDIN_CALLBACK_URL || 'http://localhost:3006/api/auth/linkedin/callback',
