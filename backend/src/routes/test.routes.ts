 ...
 */
router.post('/test/sentry-redis-error', (req: Request, res: Response) => {
 ...
 */
router.post('/test/sentry-cloudconvert-error', (req: Request, res: Response) => {
 ...
 */
router.post('/test/sentry-payfast-error', (req: Request, res: Response) => {
 ...
 */
router.post('/test/sentry-user-impact', (req: Request, res: Response) => {
 ...
 */
router.post('/test/sentry-batch-error', (req: Request, res: Response) => {
 ...
 */
router.get('/test/sentry-status', (req: Request, res: Response) => {
  res.json({
    success: true,
