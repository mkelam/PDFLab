...
export const getAllBetaApplications = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const applications = await BetaApplication.findAll({
      where,
...
export const approveBetaApplication = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const userId = req.user?.id;

    const application = await BetaApplication.findByPk(id);
    ...
    const user = await User.create({
      ...
      plan: application.plan_requested === 'pro' ? UserPlan.PRO : UserPlan.STARTER,
...
export const rejectBetaApplication = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
export const getBetaApplicationStatus = async (req: Request, res: Response): Promise<void> => {
  try {
