...
The PDFLab Team
     ...
     */
    async sendPaymentReceiptEmail(email, paymentDetails) {
...
The PDFLab Team
     ...
     */
    async sendSubscriptionCancelledEmail(email, cancellationDetails) {
...
<body>
  <div class="container">
     ...
     */
    getPaymentReceiptTemplate(paymentDetails) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="container">
     ...
     */
    getSubscriptionCancelledTemplate(cancellationDetails) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
