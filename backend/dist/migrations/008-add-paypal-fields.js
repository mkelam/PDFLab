...
async function up(queryInterface) {
    ...
    `, { transaction });
        ...
        await queryInterface.addColumn('subscriptions', 'paypal_order_id', {
            type: sequelize_1.DataTypes.STRING(255),
            allowNull: true,
        ...
        await queryInterface.addColumn('payment_logs', 'paypal_payment_id', {
            type: sequelize_1.DataTypes.STRING(255),
            allowNull: true,
            comment: 'PayPal payment or capture ID'
        }, { transaction });
        // PayPal order ID
        await queryInterface.addColumn('payment_logs', 'paypal_order_id', {
            type: sequelize_1.DataTypes.STRING(255),
            allowNull: true,
        ...
        await queryInterface.addIndex('subscriptions', ['paypal_order_id'], {
            name: 'idx_subscriptions_paypal_order_id',
            transaction
        });
        await queryInterface.addIndex('payment_logs', ['paypal_payment_id'], {
            name: 'idx_payment_logs_paypal_payment_id',
            transaction
        });
        await queryInterface.addIndex('payment_logs', ['paypal_order_id'], {
...
//# sourceMappingURL=008-add-paypal-fields.js.map