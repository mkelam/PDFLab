...
export declare const conversionTotal: client.Counter<"status" | "conversion_type" | "format">;
export declare const conversionDuration: client.Histogram<"conversion_type" | "format">;
