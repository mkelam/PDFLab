...
export declare const getConversionQueue: () => Bull.Queue | null;
export declare const getCleanupQueue: () => Bull.Queue | null;
export declare const getEmailQueue: () => Bull.Queue | null;
export declare const conversionQueue: Bull.Queue<any>;
